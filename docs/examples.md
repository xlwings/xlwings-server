...
- Task pane examples (only Office.js add-ins): [`xlwings_server/templates/examples`](https://github.com/xlwings/xlwings-server/tree/main/xlwings_server/templates/examples)
...
- Task pane: every directory in [`xlwings_server/templates/examples`](https://github.com/xlwings/xlwings-server/tree/main/xlwings_server/templates/examples) corresponds to an example and has an own `README` with instructions.

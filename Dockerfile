...
# If you have your developer license key set as XLWINGS_DEVELOPER_KEY in your build
# environment, it will install the deploy key directly in the Docker image when doing
# docker build --build-arg XLWINGS_DEVELOPER_KEY=${XLWINGS_DEVELOPER_KEY}. This is
# already set when doing with 'docker compose build'.
